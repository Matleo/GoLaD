...
<html>
  ...
  <body>
    <div class="container">
      ...
      <div class="row" id="regeln">
        <div class="col-10 offset-1">
          <div class="row">
            <div class="col-2 offset-1">
              <button id="start" type="button" class="btn btn-primary" onclick="startSimulation()">Start <i class="fas fa-step-forward"></i></button>
            </div>
